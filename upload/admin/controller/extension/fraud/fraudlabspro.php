	...
	public function order() {
		...
		if ($fraud_info) {
			...
			if ($fraud_info['ip_country']) {
				$data['flp_ip_location'] = $fraud_info['ip_country'] . ", " . $fraud_info['ip_region'] . ", " . $fraud_info['ip_city'] . " <a href=\"http://www.geolocation.com/" . $fraud_info['ip_address'] . "\" target=\"_blank\">[Map]</a>";
			} else {
